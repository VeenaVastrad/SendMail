...
class MailSender{
    ...
    $this->_mailer->SMTPAuth = true; // Set mailer to use SMTP
        if ($this->_gmail) {
            $this->_mailer->Host = 'smtp.hostinger.com';  // Gmail smtp
            $this->_mailer->Port = 587; // TCP port to connect to (Defaut 25)
    ...
    $this->_mailer->Username = 'veenav@freeboon.in';  // SMTP username
    $this->_mailer->Password = 'Veenav@3333';  // SMTP password



    $this->_mailer->addReplyTo("veenasvastrad4@gmail.com", "Recepient Name");
    $this->_mailer->From = 'veenav@freeboon.in';
...
// HTML email body
        ...
        $body .= "<thead>
						<tr height='80'>
							<th colspan='4' style='background-color:#f5f5f5; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#333; font-size:34px;'>FREEBOON MAIL</th>
						</tr>
						</thead>";
        ...
        $body .= "<tbody>
						...
						<tr>
							<td colspan='4' style='padding:15px;'>
								<p style='font-size:20px;'>Dear Sender,</p>
